...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20190314_supercompany_6aeb2806b1408a185505_20190314092805_archive.zip';
	const ARCHIVE_SIZE		 = '40977807';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '6aeb280-14092805';
	const VERSION			 = '1.3.8';
