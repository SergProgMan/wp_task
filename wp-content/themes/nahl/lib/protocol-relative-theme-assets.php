...
if ( ! class_exists( 'Nahl_Protocol_Relative_Theme_Assets' ) ) :
	class Nahl_Protocol_Relative_Theme_Assets {
		/**
	...
	$nahl_protocol_relative_theme_assets = new Nahl_Protocol_Relative_Theme_Assets;
endif;
