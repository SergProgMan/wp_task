...
/**
 * Various functions required for nahl-bootstrap to work properly
 *
 */
/*
 * Table of contests:
...
/**
 * 2 - Menu navigation walker
 * Class Name: nahl_navwalker
 * GitHub URI: https://github.com/twittem/wp-nahl-navwalker
 * Description: A custom WordPress nav walker class to implement the nahl 3 navigation style in a custom theme using the WordPress built in menu manager.
 */

class nahl_navwalker extends Walker_Nav_Menu {
...
/*
 * 3 - Pagination
 * Custom pagination with nahl .pagination class
 * source: http://www.ordinarycoder.com/paginate_links-class-ul-li-nahl/
 */
function nahl_pagination( $echo = true ) {
    global $wp_query;
 ...
 *
 */
if ( ! class_exists( 'nahl_Comments' ) ) :
    class nahl_Comments extends Walker_Comment{
