...
class Webtoffee_Wordpress_Migrator_Admin
{
    ...
    public function process_export_data()
    {
        ...
        ini_set('memory_limit', '-1');
        $step = sanitize_text_field($_POST['step']);
        $date = isset($_POST['date']) ? sanitize_text_field($_POST['date']) : date('Y-m-d-h-i-sa');
    ...
    public function add_plugin_admin_menu()
    {
         ...
         *
         */
        add_menu_page('WordPress Migration', 'WordPress Migration', 'manage_options', $this->plugin_name, array($this, 'display_plugin_setup_page'),'dashicons-image-rotate-left');
    }
