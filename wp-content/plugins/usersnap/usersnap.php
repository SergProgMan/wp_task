...
function us_register_settings() {
	...
	add_settings_field('us-user-tos', 'By signing up you agree to our <a href="https://usersnap.com/terms-of-service">Terms of Service</a> and to our <a href="https://usersnap.com/privacy-policy">Privacy Policy</a>.', 'usersnap_input_user_tos', 'usersnap_pg_new', 'usersnap_new');
...
function usersnap_input_user_tos() {
	$options = get_option('usersnap_options');
	?><input id="us-user-tos" name="usersnap_options[user-tos]" type="checkbox" value="true" /><?php
}
	...
	switch($currenttab) {
		case 'newusersnap':
			...
			jQuery('#us-settings-form').submit(function(form) {
				...
				if ((jQuery('#us-user-tos')[0].checked!==true)) {
					jQuery('.wrap h2:last').after('<div class="error below-h2" style="margin-top:1em"><p><?php _e('Please accept our terms and conditions!') ?></p></div>');
					jQuery('#us-user-tos').focus();
					return false;
				}
